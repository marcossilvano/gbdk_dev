...
#define VOL_MAX  0x02    // the bpm is not enough to MUTE the sound
#define VOL_75   0x04
#define VOL_50   0x08
#define VOL_25   0x0C
#define VOL_OFF 0x0f
...
// [CS] How ensure that a frequency array and corresponding indexes in enum
...
#define NOISE(shift, vol) \
  (u8)(0xE0 | 0x04 | (shift & 0x03)),       /* [1][11][0][0][mss] */ \
  (u8)(0x90 | 0x60 | (vol & 0x0f))          /* [1][cc][1][vvvv]   */

#define NOISE_F2(note, vol) \
  NOTE(note, VOL_OFF, 2),                  /* Set noise freq in ch2 */ \
  (u8)(0xE0 | 0x04 | 0x03),                 /* [1][11][0][0][mss]    */ \
  (u8)(0x90 | (ch << 5) | (vol & 0x0f))     /* [1][cc][1][vvvv]      */


// WAIT = 0000w wwww
// Command format: 0[tt]w wwww
#define END  0x00 // 0000 0000
#define LOOP 0x20 // 0010 0000
#define OFF  0x40 // 0100 0000
#define NEXT 0x60 // 0110 0000

static const u8 MSC_READY_CH0_PATTERN1[] = {
  NOTE(A0, VOL_MAX, 0), 
  WAIT(5),
...
static const u8 MSC_READY_CH1_PATTERN1[] = {
  NOTE(A2, VOL_MAX, 0), 
  WAIT(5),
...
static const u8 MSC_READY_CH2_PATTERN1[] = {
  WAIT(1),
  NOTE(A1, VOL_MAX, 0), 
  WAIT(5),
...
static const u8* const MUSIC_READY_CH0[] = {
  MSC_READY_CH0_PATTERN1
};

static const u8* const MUSIC_READY_CH1[] = {
  MSC_READY_CH1_PATTERN1
};

static const u8* const MUSIC_READY_CH2[] = {
  MSC_READY_CH2_PATTERN1
};

#define MUSIC_READY_BPM 3
#define MUSIC_READY_FULL_SIZE 1

// [CS] How to reduce size and reuse music patterns per channel? Pattern-pointer table system
static const u8** const MUSIC_READY_FULL[] = {
  MUSIC_READY_CH0, MUSIC_READY_CH1, MUSIC_READY_CH2
};

// typedef struct musicPointer {
//   u8** channel_array0;
//   u8** channel_array1;
//   u8** channel_array2;
// } MusicPointer;

// static const MusicPointer const MUSIC_READY_POINTER = { MUSIC_READY_CH0, MUSIC_READY_CH1, MUSIC_READY_CH2 };
...
static const u8 const SOUNDFX_BAT_APPEAR[] = {
  ...
  static const u8 const SOUNDFX_BAT_APPEAR_[] = {
  NOTE(A0, VOL_75, 1), 
  NOTE(A1, VOL_75, 1), 
  NOTE(A0, VOL_75, 1), 
...
static const u8 const SOUNDFX_EXPLOSION_[] = {
  NOISE(NOISE_SHIFT_FAST, VOL_MAX),
  WAIT(5),
  NOISE(NOISE_SHIFT_SLOW, VOL_MAX),
  WAIT(5),
  END
};

static const u8 const SOUNDFX_EXPLOSION[] = {
  NOISE(0x02, VOL_MAX),
  NOISE(0x02, VOL_MAX),
  NOISE(0x01, VOL_MAX),
  NOISE(0x01, VOL_MAX),
...
static const u8 const SOUNDFX_EXPLOSION_PLAYER[] = {
  NOISE(0x02, VOL_MAX),
  NOISE(0x01, VOL_MAX),
  NOISE(0x02, VOL_MAX),
  NOISE(0x01, VOL_MAX),
...
static const u8 const SOUNDFX_EXPLOSION_BAT[] = {
  NOISE(0x02, VOL_MAX),
  NOISE(0x01, VOL_MAX),
  NOISE(0x00, VOL_MAX),
  NOISE(0x02, VOL_MAX),
...
static const u8 const SOUNDFX_ATTACK[] = {
  NOISE(0x00, 0x02),
  NOISE(0x00, 0x02),
  NOISE(0x00, 0x02),
  NOISE(0x00, 0x02),
...
static const u8 const SOUNDFX_BOOST[] = {
  NOISE(0x02, 0x02),
  NOISE(0x02, 0x02),
  NOISE(0x02, 0x02),
  NOISE(0x02, 0x02),
